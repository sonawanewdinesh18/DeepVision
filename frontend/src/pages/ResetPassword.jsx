            ...
            <div className="lpage">
                <aside className="lpanel">
                    ...
                    <Link to="/" className="lbrand">
                        ...
                        <span className="lbrand-name"><span className="lbrand-deep">Deep</span><span className="lbrand-vision">Vision</span></span>
                    </Link>
                </aside>
                    ...
                    <div className="lform-inner">
                        <div className="lform-card">
                            ...
                            <div className="lcard-header">
                                <h1 className="lcard-title">New Password</h1>
                                <p className="lcard-sub">Please enter your new strong password.</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} noValidate className="lform">
                                ...
                                <button type="submit" className="lsubmit" disabled={isLoading}>
                                    {isLoading
                                        ...
                                        : <><span>Update Password</span><ArrowRight size={17} /></>
                                    }
                                </button>
                            </form>
                        </div>
...
.lfield-eye {
  ...
  color: #a0a0be; cursor: pointer; padding: 4px;
  display: flex; align-items: center; transition: color 0.2s;
}
.lfield-eye:hover { color: #1a73e8; }
